...
object Deps {
    ...
    object Decompose {
        const val main = "com.arkivanov.decompose:decompose:${Versions.decompose}"
        const val ext = "com.arkivanov.decompose:extensions-compose-jetbrains:${Versions.decompose}"
        ...
        const val mviKotlinExt = "com.arkivanov.mvikotlin:mvikotlin-extensions-coroutines:${Versions.mviKotlin}"
    }
